...
class GraphNode
{
	...
	public:
		...
		GraphVertice<T,U> *GetConnectedVertice(const VERTICE_ID &ConnectedVerticeNum) const { return this->_VerticeStorage.at(this->_CurVertice->GetConnectedVerticeID(ConnectedVerticeNum)); }
	...
	private:
		...
		GraphVertice<T,U>	*_CurVertice;			// Pointer to current vertice
};
