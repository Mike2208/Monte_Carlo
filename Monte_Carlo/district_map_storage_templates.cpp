#ifndef DISTRICT_MAP_STORAGE_TEMPLATES_CPP
#define DISTRICT_MAP_STORAGE_TEMPLATES_CPP
...
void DistrictMapStorage::ResetDistricts(const Map2D<T> &OriginalMap)
{
	...
	this->_IDMap.ResetMap(OriginalMap.GetWidth(), OriginalMap.GetHeight(), 0);
}
...
#endif // DISTRICT_MAP_STORAGE_TEMPLATES_CPP
